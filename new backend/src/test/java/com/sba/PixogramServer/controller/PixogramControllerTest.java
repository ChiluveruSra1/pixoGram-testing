 ...
 * com.sba.pixogram.controller.UserController; import
 * com.sba.pixogram.entity.User; import com.sba.pixogram.service.UserService;
 * import org.springframework.test.web.servlet.RequestBuilder; import
 * org.springframework.test.web.servlet.request.MockMvcRequestBuilders;
 * 
 * @RunWith(SpringRunner.class)
 * 
 * @WebMvcTest(value = UserController.class, secure = false) public class
 * PixogramControllerTest {
 * 
 ...
 * ;
 * 
 * @Test public void retrieveDetailsForCourse() throws Exception {
 * 
 * Mockito.when(
 ...
 * 
 * String expected =
 * "{\"id\":1,\"firstname\":\"Rahul\",\"lastname\":\"d\",\"username\":\"rahul_d\",\"password\":\"123456\",\"email\":\"r@e.c\"}";
 * 
